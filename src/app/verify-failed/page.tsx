...
function VerifyFailedContent() {
  ...
  return (
    <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl space-y-6 text-center">
      <div className="inline-flex bg-red-955/20 border border-red-900/40 p-4 rounded-full text-red-500 mb-2">
      ...
      <div className="pt-2 space-y-4">
        ...
        <Link
          href="/login"
          className="w-full flex items-center justify-center space-x-2 bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold py-3.5 px-4 rounded-xl text-sm transition-all duration-300"
        >
